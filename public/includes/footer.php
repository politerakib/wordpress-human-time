            ...
            <div class="flex gap-12">
                <div>
                    ...
                    <ul class="mt-3 space-y-2 text-slate-600 dark:text-slate-300">
                        <li><a href="#features" class="transition hover:text-brand">Features</a></li>
                        <li><a href="#why-us" class="transition hover:text-brand">Why Us</a></li>
                        <li><a href="#faq" class="transition hover:text-brand">FAQ</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="mt-3 space-y-2 text-slate-600 dark:text-slate-300">
                        ...
                        <li><a href="#" class="transition hover:text-brand">Terms of Service</a></li>
                    </ul>
                </div>
            </div>
        </div>
